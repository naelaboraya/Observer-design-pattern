...
public class UndoableStringBuilder {
    ...
    private UndoableStringBuilder Undo(){
        ...
        else if (Undo_Stack.size()==1&&Is_String_Constructor_used==false){//handling the case when there is one String in the stack and the object was constructed with the String constructor
            Undo_Stack.pop();
            this.sb = new StringBuilder();
            return this;
        }
